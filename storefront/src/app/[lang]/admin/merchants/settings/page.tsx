...
export default function Page() {
  ...
  const fields = [{"key":"auto_approve","label":"自动审核入驻","type":"switch"},{"key":"commission_rate","label":"默认佣金率(%)","type":"number"},{"key":"require_contract","label":"需要合同","type":"switch"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">商户设置</h1>
        <p className="text-gray-500 mt-1">商户相关配置</p>
      </div>
