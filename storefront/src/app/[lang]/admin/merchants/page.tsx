...
export default function Page() {
  ...
  const columns = [{"key":"name","label":"商户名"},{"key":"contact","label":"联系人"},{"key":"phone","label":"电话"},{"key":"status","label":"状态"},{"key":"created_at","label":"入驻时间"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">商户列表</h1>
        <p className="text-gray-500 mt-1">所有商户管理</p>
      </div>
