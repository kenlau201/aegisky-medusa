...
export default function Page() {
  ...
  const fields = [{"key":"title","label":"标题"},{"key":"content","label":"招商内容","type":"textarea"},{"key":"contact_email","label":"联系邮箱"},{"key":"benefits","label":"入驻优势","type":"textarea"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">招商内容</h1>
        <p className="text-gray-500 mt-1">编辑招商页面内容</p>
      </div>
