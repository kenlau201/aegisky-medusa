...
export default function Page() {
  ...
  const columns = [{"key":"company","label":"企业名"},{"key":"contact","label":"联系人"},{"key":"license","label":"营业执照"},{"key":"status","label":"状态"},{"key":"submitted","label":"提交时间"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">企业认证</h1>
        <p className="text-gray-500 mt-1">企业客户认证</p>
      </div>
