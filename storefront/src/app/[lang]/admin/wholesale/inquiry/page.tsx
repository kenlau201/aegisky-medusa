...
export default function Page() {
  ...
  const columns = [{"key":"id","label":"询价单号"},{"key":"customer","label":"客户"},{"key":"product","label":"商品"},{"key":"quantity","label":"数量"},{"key":"status","label":"状态"},{"key":"created_at","label":"时间"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">询价管理</h1>
        <p className="text-gray-500 mt-1">批发询价单</p>
      </div>
