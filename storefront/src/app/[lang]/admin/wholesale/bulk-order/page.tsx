...
export default function Page() {
  ...
  const columns = [{"key":"order","label":"订单号"},{"key":"customer","label":"客户"},{"key":"items","label":"商品数"},{"key":"amount","label":"金额"},{"key":"status","label":"状态"},{"key":"created_at","label":"时间"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">批量订单</h1>
        <p className="text-gray-500 mt-1">批量采购订单</p>
      </div>
