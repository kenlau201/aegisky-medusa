...
export default function Page() {
  ...
  const columns = [{"key":"product","label":"商品"},{"key":"min_qty","label":"起订量"},{"key":"price","label":"批发价"},{"key":"tier","label":"价格阶梯"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">价格控制</h1>
        <p className="text-gray-500 mt-1">批发价格规则</p>
      </div>
