...
export default function Page() {
  ...
  const columns = [{"key":"company","label":"公司名"},{"key":"contact","label":"联系人"},{"key":"phone","label":"电话"},{"key":"type","label":"类型"},{"key":"status","label":"状态"},{"key":"submitted","label":"提交时间"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">入驻申请</h1>
        <p className="text-gray-500 mt-1">商户入驻申请审核</p>
      </div>
