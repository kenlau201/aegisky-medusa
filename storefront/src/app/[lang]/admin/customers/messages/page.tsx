...
export default function Page() {
  ...
  const columns = [{"key":"title","label":"标题"},{"key":"recipient","label":"接收人"},{"key":"type","label":"类型"},{"key":"read","label":"已读"},{"key":"created_at","label":"时间"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">站内信</h1>
        <p className="text-gray-500 mt-1">站内消息管理</p>
      </div>
