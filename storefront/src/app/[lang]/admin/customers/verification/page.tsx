...
export default function Page() {
  ...
  const columns = [{"key":"name","label":"姓名"},{"key":"type","label":"认证类型"},{"key":"id_number","label":"证件号"},{"key":"status","label":"状态"},{"key":"submitted","label":"提交时间"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">客户认证</h1>
        <p className="text-gray-500 mt-1">实名认证审核</p>
      </div>
