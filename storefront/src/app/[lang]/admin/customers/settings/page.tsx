...
export default function Page() {
  ...
  const fields = [{"key":"allow_register","label":"允许注册","type":"switch"},{"key":"need_verify","label":"需要邮箱验证","type":"switch"},{"key":"default_level","label":"默认等级","type":"select","options":["普通会员","银卡会员","金卡会员","钻石会员"]}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">客户设置</h1>
        <p className="text-gray-500 mt-1">客户相关设置</p>
      </div>
