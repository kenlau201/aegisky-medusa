...
export default function Page() {
  ...
  const fields = [{"key":"enable_kyc","label":"启用实名认证","type":"switch"},{"key":"auto_approve","label":"自动审核","type":"switch"},{"key":"required_fields","label":"必填字段","type":"textarea"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">认证设置</h1>
        <p className="text-gray-500 mt-1">实名认证配置</p>
      </div>
