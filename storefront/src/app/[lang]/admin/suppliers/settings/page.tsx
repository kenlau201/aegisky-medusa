...
export default function Page() {
  ...
  const fields = [{"key":"auto_approve","label":"自动审核供应商","type":"switch"},{"key":"require_certification","label":"需要资质认证","type":"switch"},{"key":"default_commission","label":"默认佣金率(%)","type":"number"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">供应商设置</h1>
        <p className="text-gray-500 mt-1">供应商管理配置</p>
      </div>
