...
export default function Page() {
  ...
  const columns = [{"key":"name","label":"商品名"},{"key":"supplier","label":"供应商"},{"key":"price","label":"价格"},{"key":"stock","label":"库存"},{"key":"status","label":"状态"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">供应商商品</h1>
        <p className="text-gray-500 mt-1">供应商商品列表</p>
      </div>
