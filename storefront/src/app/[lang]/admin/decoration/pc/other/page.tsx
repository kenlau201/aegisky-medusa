...
export default function PCPage() {
  ...
  const fields = [{"key":"custom_css","label":"自定义CSS","type":"textarea"},{"key":"custom_js","label":"自定义JS","type":"textarea"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">PC其他页面</h1>
        <p className="text-gray-500 mt-1">PC端其他页面设置</p>
      </div>
