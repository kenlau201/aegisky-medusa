...
export default function PCPage() {
  ...
  const fields = [{"key":"title","label":"页面标题"},{"key":"content","label":"页面内容","type":"textarea"},{"key":"seo_title","label":"SEO标题"},{"key":"seo_desc","label":"SEO描述"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">PC自定义页</h1>
        <p className="text-gray-500 mt-1">PC端自定义页面装修</p>
      </div>
