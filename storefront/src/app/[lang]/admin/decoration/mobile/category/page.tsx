...
export default function Page() {
  ...
  const fields = [{"key":"layout","label":"布局样式","type":"select","options":["图标式","列表式","大图式"]},{"key":"show_banner","label":"显示Banner","type":"switch"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">移动端分类页</h1>
        <p className="text-gray-500 mt-1">移动端分类页装修</p>
      </div>
