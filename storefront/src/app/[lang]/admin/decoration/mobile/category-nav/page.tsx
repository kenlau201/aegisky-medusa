...
export default function Page() {
  ...
  const columns = [{"key":"name","label":"名称"},{"key":"icon","label":"图标"},{"key":"link","label":"链接"},{"key":"sort","label":"排序"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">分类导航</h1>
        <p className="text-gray-500 mt-1">移动端分类导航</p>
      </div>
