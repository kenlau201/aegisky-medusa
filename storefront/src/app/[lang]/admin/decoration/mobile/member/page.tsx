...
export default function Page() {
  ...
  const fields = [{"key":"show_avatar","label":"显示头像","type":"switch"},{"key":"show_balance","label":"显示余额","type":"switch"},{"key":"menu_items","label":"菜单项","type":"textarea"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">会员页装修</h1>
        <p className="text-gray-500 mt-1">移动端会员中心</p>
      </div>
