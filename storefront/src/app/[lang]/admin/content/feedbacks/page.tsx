...
export default function Page() {
  ...
  const columns = [{"key":"name","label":"用户"},{"key":"contact","label":"联系方式"},{"key":"content","label":"内容"},{"key":"status","label":"状态"},{"key":"created_at","label":"时间"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">留言反馈</h1>
        <p className="text-gray-500 mt-1">用户留言反馈</p>
      </div>
