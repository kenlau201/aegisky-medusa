...
export default function Page() {
  ...
  const columns = [{"key":"title","label":"标题"},{"key":"author","label":"作者"},{"key":"category","label":"分类"},{"key":"views","label":"浏览"},{"key":"status","label":"状态"},{"key":"created_at","label":"时间"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">文章内容</h1>
        <p className="text-gray-500 mt-1">管理文章内容</p>
      </div>
