...
export default function Page() {
  ...
  const fields = [{"key":"enable","label":"启用分销","type":"switch"},{"key":"commission_type","label":"佣金类型","type":"select","options":["百分比","固定金额"]},{"key":"settlement_day","label":"结算日","type":"number","hint":"每月几号结算"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">分销设置</h1>
        <p className="text-gray-500 mt-1">分销全局设置</p>
      </div>
