...
export default function Page() {
  ...
  const columns = [{"key":"customer","label":"客户"},{"key":"distributor","label":"分销员"},{"key":"order","label":"订单"},{"key":"amount","label":"金额"},{"key":"commission","label":"佣金"},{"key":"created_at","label":"时间"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">客户成交</h1>
        <p className="text-gray-500 mt-1">分销客户成交记录</p>
      </div>
