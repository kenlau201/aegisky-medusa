...
export default function Page() {
  ...
  const columns = [{"key":"product","label":"商品"},{"key":"commission_rate","label":"佣金比例"},{"key":"commission_amount","label":"佣金金额"},{"key":"sales","label":"销量"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">佣金管理</h1>
        <p className="text-gray-500 mt-1">商品佣金设置</p>
      </div>
