...
export default function Page() {
  ...
  const fields = [{"key":"period","label":"结算周期","type":"select","options":["周结","半月结","月结"]},{"key":"min_amount","label":"最低结算金额","type":"number"},{"key":"auto_settle","label":"自动结算","type":"switch"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">分销结算方案配置</p>
      </div>
