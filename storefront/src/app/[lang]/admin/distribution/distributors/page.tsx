...
export default function Page() {
  ...
  const columns = [{"key":"name","label":"姓名"},{"key":"phone","label":"手机"},{"key":"level","label":"等级"},{"key":"orders","label":"订单"},{"key":"commission","label":"佣金"},{"key":"status","label":"状态"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">分销员管理</h1>
        <p className="text-gray-500 mt-1">分销员列表</p>
      </div>
