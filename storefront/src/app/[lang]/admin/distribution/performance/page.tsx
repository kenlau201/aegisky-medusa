...
export default function Page() {
  ...
  const columns = [{"key":"distributor","label":"分销员"},{"key":"period","label":"结算周期"},{"key":"orders","label":"订单数"},{"key":"amount","label":"业绩"},{"key":"commission","label":"佣金"},{"key":"status","label":"状态"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">业绩结算</h1>
        <p className="text-gray-500 mt-1">分销业绩结算</p>
      </div>
