...
export default function Page() {
  ...
  const columns = [{"key":"rank","label":"排名"},{"key":"name","label":"分销员"},{"key":"orders","label":"订单"},{"key":"sales","label":"销售额"},{"key":"commission","label":"佣金"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">分销员排行</h1>
        <p className="text-gray-500 mt-1">分销员业绩排行</p>
      </div>
