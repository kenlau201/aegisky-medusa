...
export default function Page() {
  ...
  const columns = [{"key":"name","label":"分组名"},{"key":"count","label":"人数"},{"key":"commission_rate","label":"佣金比例"},{"key":"created_at","label":"创建时间"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">分销员分组</h1>
        <p className="text-gray-500 mt-1">分销员分组管理</p>
      </div>
