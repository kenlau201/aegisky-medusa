...
export default function Page() {
  ...
  const columns = [{"key":"name","label":"分销员"},{"key":"orders","label":"订单数"},{"key":"sales","label":"销售额"},{"key":"commission","label":"佣金"},{"key":"level","label":"等级"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">分销员明细</h1>
        <p className="text-gray-500 mt-1">分销员详细数据</p>
      </div>
