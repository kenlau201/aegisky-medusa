...
export default function Page() {
  ...
  const columns = [{"key":"title","label":"标题"},{"key":"type","label":"类型"},{"key":"category","label":"分类"},{"key":"views","label":"浏览"},{"key":"created_at","label":"时间"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">素材管理</h1>
        <p className="text-gray-500 mt-1">分销素材管理</p>
      </div>
