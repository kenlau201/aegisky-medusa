...
export default function Page() {
  ...
  const columns = [{"key":"username","label":"用户名"},{"key":"email","label":"邮箱"},{"key":"role","label":"角色"},{"key":"last_login","label":"最后登录"},{"key":"status","label":"状态"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">账号管理</h1>
        <p className="text-gray-500 mt-1">账号安全管理</p>
      </div>
