...
export default function Page() {
  ...
  const columns = [{"key":"id","label":"ID"},{"key":"distributor","label":"分销员"},{"key":"order","label":"订单"},{"key":"amount","label":"佣金"},{"key":"status","label":"状态"},{"key":"created_at","label":"时间"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">分销佣金</h1>
        <p className="text-gray-500 mt-1">分销佣金记录</p>
      </div>
