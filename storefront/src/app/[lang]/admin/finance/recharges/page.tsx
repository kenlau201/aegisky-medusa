...
export default function Page() {
  ...
  const columns = [{"key":"id","label":"订单号"},{"key":"customer","label":"用户"},{"key":"amount","label":"金额"},{"key":"method","label":"支付方式"},{"key":"status","label":"状态"},{"key":"created_at","label":"时间"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">充值管理</h1>
        <p className="text-gray-500 mt-1">用户充值记录</p>
      </div>
