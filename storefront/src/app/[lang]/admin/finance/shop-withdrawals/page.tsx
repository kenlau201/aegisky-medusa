...
export default function Page() {
  ...
  const columns = [{"key":"id","label":"提现单号"},{"key":"shop","label":"店铺"},{"key":"amount","label":"金额"},{"key":"status","label":"状态"},{"key":"created_at","label":"时间"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">店铺提现</h1>
        <p className="text-gray-500 mt-1">店铺提现申请</p>
      </div>
