...
export default function Page() {
  ...
  const columns = [{"key":"id","label":"ID"},{"key":"supplier","label":"供应商"},{"key":"type","label":"类型"},{"key":"amount","label":"金额"},{"key":"created_at","label":"时间"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">供应商资金日志</h1>
        <p className="text-gray-500 mt-1">供应商资金变动</p>
      </div>
