...
export default function Page() {
  ...
  const columns = [{"key":"id","label":"ID"},{"key":"shop","label":"店铺"},{"key":"type","label":"类型"},{"key":"amount","label":"金额"},{"key":"created_at","label":"时间"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">店铺资金日志</h1>
        <p className="text-gray-500 mt-1">店铺资金变动记录</p>
      </div>
