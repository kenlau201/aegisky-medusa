...
export default function Page() {
  ...
  const fields = [{"key":"auto_settlement","label":"自动分账","type":"switch"},{"key":"settlement_period","label":"结算周期","type":"select","options":["T+1","T+7","T+15","T+30"]},{"key":"min_amount","label":"最低结算金额","type":"number"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">分账设置</h1>
        <p className="text-gray-500 mt-1">配置自动分账规则</p>
      </div>
