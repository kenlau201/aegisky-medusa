...
export default function Page() {
  ...
  const columns = [{"key":"id","label":"ID"},{"key":"customer","label":"用户"},{"key":"type","label":"类型"},{"key":"points","label":"积分"},{"key":"description","label":"描述"},{"key":"created_at","label":"时间"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">积分日志</h1>
        <p className="text-gray-500 mt-1">积分变动记录</p>
      </div>
