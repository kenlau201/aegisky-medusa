...
export default function Page() {
  ...
  const columns = [{"key":"shop","label":"店铺"},{"key":"balance","label":"可用余额"},{"key":"frozen","label":"冻结金额"},{"key":"total","label":"累计收入"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">店铺资金</h1>
        <p className="text-gray-500 mt-1">店铺资金余额</p>
      </div>
