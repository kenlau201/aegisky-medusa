...
export default function Page() {
  ...
  const fields = [{"key":"min_withdrawal","label":"最低提现金额","type":"number"},{"key":"withdrawal_fee_rate","label":"提现手续费率(%)","type":"number"},{"key":"auto_approve","label":"自动审核","type":"switch"},{"key":"methods","label":"提现方式","type":"textarea","hint":"每行一种方式"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">提现设置</h1>
        <p className="text-gray-500 mt-1">配置提现规则</p>
      </div>
