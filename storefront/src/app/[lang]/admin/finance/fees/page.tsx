...
export default function Page() {
  ...
  const fields = [{"key":"platform_fee","label":"平台费率(%)","type":"number","hint":"每笔交易收取的平台服务费比例"},{"key":"payment_fee","label":"支付费率(%)","type":"number"},{"key":"withdrawal_fee","label":"提现手续费","type":"number"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">服务费率</h1>
        <p className="text-gray-500 mt-1">设置平台服务费率</p>
      </div>
