...
export default function Page() {
  ...
  const columns = [{"key":"period","label":"账期"},{"key":"supplier","label":"供应商"},{"key":"orders","label":"订单数"},{"key":"amount","label":"金额"},{"key":"status","label":"状态"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">供应商对账单</h1>
        <p className="text-gray-500 mt-1">供应商对账单</p>
      </div>
