...
export default function Page() {
  ...
  const columns = [{"key":"order","label":"订单号"},{"key":"shop","label":"店铺"},{"key":"amount","label":"金额"},{"key":"fee","label":"手续费"},{"key":"created_at","label":"时间"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">对账单明细</h1>
        <p className="text-gray-500 mt-1">对账单详细明细</p>
      </div>
