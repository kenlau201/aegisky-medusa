...
export default function Page() {
  ...
  const columns = [{"key":"id","label":"结算单号"},{"key":"shop","label":"店铺"},{"key":"amount","label":"结算金额"},{"key":"status","label":"状态"},{"key":"created_at","label":"时间"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">分账管理</h1>
        <p className="text-gray-500 mt-1">店铺分账记录</p>
      </div>
