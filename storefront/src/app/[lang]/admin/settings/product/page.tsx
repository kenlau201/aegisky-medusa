...
export default function Page() {
  ...
  const fields = [{"key":"auto_approve","label":"商品自动审核","type":"switch"},{"key":"default_stock","label":"默认库存","type":"number"},{"key":"enable_review","label":"开启评价","type":"switch"},{"key":"review_audit","label":"评价需审核","type":"switch"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">商品设置</h1>
        <p className="text-gray-500 mt-1">商品相关配置</p>
      </div>
