...
export default function Page() {
  ...
  const fields = [{"key":"license","label":"授权码","hint":"请输入正版授权码"},{"key":"domain","label":"授权域名"},{"key":"expiry","label":"到期时间","type":"date"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">授权信息</h1>
        <p className="text-gray-500 mt-1">系统授权信息</p>
      </div>
