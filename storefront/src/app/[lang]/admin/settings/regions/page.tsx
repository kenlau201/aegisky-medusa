...
export default function Page() {
  ...
  const columns = [{"key":"name","label":"地区"},{"key":"code","label":"编码"},{"key":"parent","label":"上级"},{"key":"sort","label":"排序"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">地区管理</h1>
        <p className="text-gray-500 mt-1">配送地区管理</p>
      </div>
