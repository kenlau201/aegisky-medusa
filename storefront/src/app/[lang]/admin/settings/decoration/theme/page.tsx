...
export default function Page() {
  ...
  const fields = [{"key":"theme","label":"主题","type":"select","options":["默认蓝","科技黑","活力橙","清新绿"]},{"key":"layout","label":"布局","type":"select","options":["经典","简约","现代"]}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">主题风格</h1>
        <p className="text-gray-500 mt-1">店铺主题设置</p>
      </div>
