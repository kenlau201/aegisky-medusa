...
export default function Page() {
  ...
  const columns = [{"key":"name","label":"名称"},{"key":"image","label":"图片"},{"key":"link","label":"跳转链接"},{"key":"start","label":"开始时间"},{"key":"end","label":"结束时间"},{"key":"status","label":"状态"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">开屏广告</h1>
        <p className="text-gray-500 mt-1">APP开屏广告</p>
      </div>
