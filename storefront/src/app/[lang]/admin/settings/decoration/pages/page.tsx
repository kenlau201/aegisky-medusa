...
export default function Page() {
  ...
  const columns = [{"key":"title","label":"标题"},{"key":"path","label":"路径"},{"key":"views","label":"浏览"},{"key":"status","label":"状态"},{"key":"updated","label":"更新时间"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">页面管理</h1>
        <p className="text-gray-500 mt-1">自定义页面</p>
      </div>
