...
export default function Page() {
  ...
  const fields = [{"key":"enable","label":"启用打印","type":"switch"},{"key":"printer_name","label":"打印机名称"},{"key":"header","label":"小票头部","type":"textarea"},{"key":"footer","label":"小票尾部","type":"textarea"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">小票打印</h1>
        <p className="text-gray-500 mt-1">小票打印设置</p>
      </div>
