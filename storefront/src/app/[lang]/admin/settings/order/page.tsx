...
export default function Page() {
  ...
  const fields = [{"key":"order_prefix","label":"订单号前缀"},{"key":"invoice_enable","label":"开启发票","type":"switch"},{"key":"comment_enable","label":"开启备注","type":"switch"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">订单设置</h1>
        <p className="text-gray-500 mt-1">订单相关配置</p>
      </div>
