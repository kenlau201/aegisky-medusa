...
export default function Page() {
  ...
  const fields = [{"key":"app_id","label":"AppID"},{"key":"app_secret","label":"AppSecret"},{"key":"page_path","label":"首页路径"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">小程序设置</h1>
        <p className="text-gray-500 mt-1">小程序配置</p>
      </div>
