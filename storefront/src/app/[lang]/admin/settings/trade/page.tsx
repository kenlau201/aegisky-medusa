...
export default function Page() {
  ...
  const fields = [{"key":"auto_cancel_hours","label":"未付款自动取消(小时)","type":"number"},{"key":"auto_confirm_days","label":"自动确认收货(天)","type":"number"},{"key":"allow_refund_days","label":"允许退款天数","type":"number"},{"key":"tax_rate","label":"税率(%)","type":"number"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">交易设置</h1>
        <p className="text-gray-500 mt-1">交易相关配置</p>
      </div>
