...
export default function Page() {
  ...
  const fields = [{"key":"site_name","label":"站点名称"},{"key":"site_logo","label":"Logo URL"},{"key":"site_description","label":"站点描述","type":"textarea"},{"key":"contact_email","label":"联系邮箱"},{"key":"contact_phone","label":"联系电话"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">系统全局配置</p>
      </div>
