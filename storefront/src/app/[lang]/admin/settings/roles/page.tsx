...
export default function Page() {
  ...
  const columns = [{"key":"name","label":"角色名"},{"key":"description","label":"描述"},{"key":"permissions","label":"权限数"},{"key":"admins","label":"管理员数"},{"key":"created_at","label":"创建时间"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">角色管理</h1>
        <p className="text-gray-500 mt-1">管理员角色权限</p>
      </div>
