...
export default function Page() {
  ...
  const fields = [{"key":"stripe_enable","label":"Stripe支付","type":"switch"},{"key":"stripe_key","label":"Stripe Public Key"},{"key":"stripe_secret","label":"Stripe Secret Key"},{"key":"paypal_enable","label":"PayPal支付","type":"switch"},{"key":"wire_transfer","label":"银行转账","type":"switch"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">支付方式配置</p>
      </div>
