...
export default function Page() {
  ...
  const columns = [{"key":"admin","label":"管理员"},{"key":"action","label":"操作"},{"key":"target","label":"对象"},{"key":"ip","label":"IP"},{"key":"created_at","label":"时间"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">操作日志</h1>
        <p className="text-gray-500 mt-1">管理员操作记录</p>
      </div>
