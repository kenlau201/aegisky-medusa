...
export default function Page() {
  ...
  const fields = [{"key":"mode","label":"经营模式","type":"select","options":["B2C零售","B2B批发","B2B2C多商户","供应链平台"]},{"key":"multi_shop","label":"多商户模式","type":"switch"},{"key":"cross_border","label":"跨境模式","type":"switch"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">经营模式</h1>
        <p className="text-gray-500 mt-1">设置店铺经营模式</p>
      </div>
