...
export default function Page() {
  ...
  const fields = [{"key":"email_notify","label":"邮件通知","type":"switch"},{"key":"sms_notify","label":"短信通知","type":"switch"},{"key":"new_order","label":"新订单通知","type":"switch"},{"key":"new_rfq","label":"新RFQ通知","type":"switch"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">消息通知配置</p>
      </div>
