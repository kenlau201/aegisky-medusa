...
export default function Page() {
  ...
  const columns = [{"key":"name","label":"公司名"},{"key":"code","label":"编码"},{"key":"tracking_url","label":"查询网址"},{"key":"status","label":"状态"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">物流公司</h1>
        <p className="text-gray-500 mt-1">物流服务商管理</p>
      </div>
