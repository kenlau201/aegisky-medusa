...
export default function Page() {
  ...
  const fields = [{"key":"free_shipping_threshold","label":"免运费门槛","type":"number"},{"key":"default_shipping_fee","label":"默认运费","type":"number"},{"key":"enable_international","label":"国际配送","type":"switch"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">配送设置</h1>
        <p className="text-gray-500 mt-1">配送区域和运费</p>
      </div>
