...
export default function Page() {
  ...
  const fields = [{"key":"email_login","label":"邮箱登录","type":"switch"},{"key":"phone_login","label":"手机登录","type":"switch"},{"key":"google_login","label":"Google登录","type":"switch"},{"key":"github_login","label":"GitHub登录","type":"switch"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">登录设置</h1>
        <p className="text-gray-500 mt-1">登录方式配置</p>
      </div>
