...
export default function PCPage() {
  ...
  const columns = [{"key":"name","label":"名称"},{"key":"link","label":"链接"},{"key":"sort","label":"排序"},{"key":"status","label":"状态"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">PC导航</h1>
        <p className="text-gray-500 mt-1">PC端导航菜单</p>
      </div>
