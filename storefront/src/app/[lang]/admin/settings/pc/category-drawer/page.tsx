...
export default function Page() {
  ...
  const columns = [{"key":"category","label":"分类"},{"key":"icon","label":"图标"},{"key":"sort","label":"排序"},{"key":"show","label":"显示"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">分类抽屉</h1>
        <p className="text-gray-500 mt-1">PC端分类抽屉配置</p>
      </div>
