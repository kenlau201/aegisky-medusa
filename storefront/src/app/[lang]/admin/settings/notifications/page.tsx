...
export default function Page() {
  ...
  const columns = [{"key":"title","label":"标题"},{"key":"type","label":"类型"},{"key":"audience","label":"接收人"},{"key":"sent","label":"发送时间"},{"key":"status","label":"状态"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">消息管理</h1>
        <p className="text-gray-500 mt-1">系统消息通知</p>
      </div>
