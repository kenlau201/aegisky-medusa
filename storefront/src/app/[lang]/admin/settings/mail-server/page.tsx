...
export default function Page() {
  ...
  const fields = [{"key":"smtp_host","label":"SMTP服务器"},{"key":"smtp_port","label":"端口","type":"number"},{"key":"smtp_user","label":"用户名"},{"key":"smtp_pass","label":"密码","type":"password"},{"key":"from_email","label":"发件人邮箱"},{"key":"from_name","label":"发件人名称"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">邮件服务器</h1>
        <p className="text-gray-500 mt-1">SMTP邮件配置</p>
      </div>
