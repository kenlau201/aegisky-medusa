...
export default function Page() {
  ...
  const fields = [{"key":"enable_chat","label":"启用在线客服","type":"switch"},{"key":"chat_url","label":"客服链接"},{"key":"service_hours","label":"服务时间"},{"key":"service_phone","label":"客服电话"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">在线客服配置</p>
      </div>
