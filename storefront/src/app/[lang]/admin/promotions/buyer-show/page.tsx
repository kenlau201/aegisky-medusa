...
export default function Page() {
  ...
  const columns = [{"key":"customer","label":"用户"},{"key":"product","label":"商品"},{"key":"content","label":"内容"},{"key":"likes","label":"点赞"},{"key":"status","label":"状态"},{"key":"created_at","label":"时间"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">买家秀</h1>
        <p className="text-gray-500 mt-1">买家秀管理</p>
      </div>
