...
export default function Page() {
  ...
  const columns = [{"key":"name","label":"卡券名"},{"key":"type","label":"类型"},{"key":"value","label":"面值"},{"key":"issued","label":"已发放"},{"key":"used","label":"已使用"},{"key":"status","label":"状态"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">电子卡券</h1>
        <p className="text-gray-500 mt-1">电子卡券管理</p>
      </div>
