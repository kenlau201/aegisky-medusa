...
export default function Page() {
  ...
  const columns = [{"key":"product","label":"商品"},{"key":"points","label":"所需积分"},{"key":"price","label":"现金价"},{"key":"stock","label":"库存"},{"key":"redeemed","label":"已兑换"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">积分商品</h1>
        <p className="text-gray-500 mt-1">积分兑换商品</p>
      </div>
