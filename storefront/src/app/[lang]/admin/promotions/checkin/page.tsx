...
export default function Page() {
  ...
  const fields = [{"key":"enable","label":"启用签到","type":"switch"},{"key":"daily_points","label":"每日签到积分","type":"number"},{"key":"continuous_bonus","label":"连续签到奖励","type":"textarea","hint":"格式: 天数=积分,每行一条"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">日历签到</h1>
        <p className="text-gray-500 mt-1">签到活动配置</p>
      </div>
