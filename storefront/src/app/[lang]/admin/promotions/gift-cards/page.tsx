...
export default function Page() {
  ...
  const columns = [{"key":"code","label":"卡号"},{"key":"amount","label":"面值"},{"key":"balance","label":"余额"},{"key":"customer","label":"持有人"},{"key":"status","label":"状态"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">礼品卡</h1>
        <p className="text-gray-500 mt-1">礼品卡管理</p>
      </div>
