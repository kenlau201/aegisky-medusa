...
export default function Page() {
  ...
  const columns = [{"key":"rank","label":"排名"},{"key":"customer","label":"客户"},{"key":"orders","label":"订单数"},{"key":"amount","label":"消费金额"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">消费排行</h1>
        <p className="text-gray-500 mt-1">客户消费排行榜</p>
      </div>
