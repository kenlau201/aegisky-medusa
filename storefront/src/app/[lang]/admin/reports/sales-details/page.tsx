...
export default function Page() {
  ...
  const columns = [{"key":"product","label":"商品"},{"key":"sku","label":"SKU"},{"key":"quantity","label":"销量"},{"key":"amount","label":"销售额"},{"key":"orders","label":"订单数"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">销售明细</h1>
        <p className="text-gray-500 mt-1">商品销售明细</p>
      </div>
