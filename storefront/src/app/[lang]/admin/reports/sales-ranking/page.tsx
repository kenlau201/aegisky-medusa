...
export default function Page() {
  ...
  const columns = [{"key":"rank","label":"排名"},{"key":"product","label":"商品"},{"key":"sales","label":"销量"},{"key":"amount","label":"销售额"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">销售排行</h1>
        <p className="text-gray-500 mt-1">商品销售排行榜</p>
      </div>
