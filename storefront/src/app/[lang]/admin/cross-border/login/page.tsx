...
export default function Page() {
  ...
  const fields = [{"key":"google","label":"Google登录","type":"switch"},{"key":"facebook","label":"Facebook登录","type":"switch"},{"key":"apple","label":"Apple登录","type":"switch"},{"key":"twitter","label":"Twitter登录","type":"switch"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">海外第三方登录</p>
      </div>
