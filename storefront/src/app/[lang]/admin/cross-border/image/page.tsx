...
export default function Page() {
  ...
  const fields = [{"key":"auto_translate","label":"自动翻译图片文字","type":"switch"},{"key":"auto_resize","label":"自动压缩","type":"switch"},{"key":"watermark","label":"添加水印","type":"switch"},{"key":"cdn_enable","label":"CDN加速","type":"switch"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">图片智能处理</h1>
        <p className="text-gray-500 mt-1">AI图片处理配置</p>
      </div>
