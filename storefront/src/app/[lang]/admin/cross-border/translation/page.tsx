...
export default function Page() {
  ...
  const columns = [{"key":"lang","label":"语言"},{"key":"translated","label":"已翻译"},{"key":"total","label":"总数"},{"key":"progress","label":"进度"},{"key":"status","label":"状态"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">翻译管理</h1>
        <p className="text-gray-500 mt-1">多语言翻译管理</p>
      </div>
