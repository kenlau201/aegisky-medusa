...
export default function Page() {
  ...
  const fields = [{"key":"default_status","label":"默认店铺状态","type":"select","options":["启用","禁用"]},{"key":"allow_multi_shop","label":"允许多店铺","type":"switch"},{"key":"shop_review","label":"店铺审核","type":"switch"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">店铺全局设置</p>
      </div>
