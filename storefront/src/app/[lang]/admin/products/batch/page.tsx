...
export default function Page() {
  ...
  const fields = [{"key":"import_file","label":"导入文件","type":"file","hint":"支持CSV/Excel格式"},{"key":"export_format","label":"导出格式","type":"select","options":["CSV","Excel","JSON"]}];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">商品批量导入导出</p>
      </div>
