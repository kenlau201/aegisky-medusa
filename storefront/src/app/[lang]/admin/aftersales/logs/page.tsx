...
export default function Page() {
  ...
  const columns = [{"key":"id","label":"退款单号"},{"key":"order","label":"订单号"},{"key":"amount","label":"金额"},{"key":"reason","label":"原因"},{"key":"operator","label":"操作人"},{"key":"created_at","label":"时间"}];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">退款日志</h1>
        <p className="text-gray-500 mt-1">退款操作记录</p>
      </div>
