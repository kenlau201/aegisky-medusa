// SVG icons for solution categories
interface IconProps {
  className?: string
}

export function CategoryIcon({ icon, className = 'w-6 h-6' }: { icon: string; className?: string }) {
...
export function BookmarkIcon({ className = 'w-5 h-5', filled = false }: IconProps & { filled?: boolean }) {
  return (
