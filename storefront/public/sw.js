/**
 * Aegisky Medusa Service Worker
 * PWA offline support for B2B platform
 */

const CACHE_NAME = 'aegisky-v1'
const STATIC_ASSETS = [
  '/',
  '/en',
  '/manifest.json',
...
self.addEventListener('fetch', (event) => {
  ...
  if (request.url.includes('/api/') || request.url.includes('/store/')) return
